...
export const PLUGroupItemName = 'GP'; // will be used to search for the item in the menu manager
...
export const GroupPLU = PLUGroupItemName + PLUNumber[Math.floor(Math.random() * PLUNumber.length)]; // will be used to search for the item in the menu manager
