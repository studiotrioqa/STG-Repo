...
export class AddGroupItemToMenuCategory {
    ...
    async addGroupItemtoMenuCategory(GroupPLU: string): Promise<void> {
        ...
        await this.page.locator('[data-test-id="virtuoso-item-list"] div').nth(0).click();
        await this.page.locator('[data-test-id="virtuoso-item-list"] div').nth(6).click();
        await this.page.locator('[data-test-id="virtuoso-item-list"] div').nth(12).click();
        await this.page.locator('[data-test-id="virtuoso-item-list"] div').nth(18).click();
        await this.page.locator('[data-test-id="virtuoso-item-list"] div').nth(24).click();
