...
import { AddNormalItemToMenuCategory,  AddGroupItemToMenuCategory} from '../../../../Pages/Menu_Manager/2.Menus/addItemToAMenuCategory';
...
test('Add Group Item to a Menu Category', async ({page}, testInfo) => {
  ...
  const addGroupItemToMenuCategory = new AddGroupItemToMenuCategory(loggedPage);
